---
title: "Flesh on the Bones: Drafting Section by Section"
slug: "express"
...
1. The **Style Sheet** (if you created one)
2. A single **source material document** containing:
   - Main point/thesis
...
**Option 1**: Modify your bullet point outline in Notion. Insert instructions formatted to stand out—Claude will follow guideposts like `<embellish this point>` from within the document.
...
1. Prompt for a section draft
2. Review the output
3. Provide feedback or edits
