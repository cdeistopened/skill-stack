---
title: "Distill & Express: Bridging the Archipelago"
slug: "express-book"
...
1. **Start a fresh conversation** with Claude, providing:
   - Your style sheet (if you have one)
   - The chapter outline
   - The archipelago of source material

2. **Draft section by section**, not all at once:
   > "Let's start with section 1. Draft 300-400 words based on this outline, incorporating quotes where appropriate."

3. **Review and iterate** after each section before moving to the next.

4. **Build transitions** between sections:
