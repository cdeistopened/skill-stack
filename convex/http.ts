...
// Site configuration
const SITE_URL = process.env.SITE_URL || "https://skillstack.md";
const SITE_NAME = "Skill Stack";
...
function generateMetaHtml(content: {
  ...
  const siteUrl = process.env.SITE_URL || "https://skillstack.md";
  const siteName = "Skill Stack";
